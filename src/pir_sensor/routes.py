...
from .sensor import get_pir_sensor, start_pir_monitoring, stop_pir_monitoring, add_motion_callback, remove_motion_callback
...
def start_monitoring():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({'success': False, 'message': 'Failed to start PIR monitoring'}), 500
