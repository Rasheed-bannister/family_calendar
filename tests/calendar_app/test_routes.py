...
def test_filter_events_for_day_single_day_event():
    ...
    event = {
        'id': '1',
        'summary': 'Test Event',
        'start_datetime': datetime.datetime(2025, 5, 15, 10, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 15, 11, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': False
    }
    events = [event]
...
def test_filter_events_for_day_multi_day_event_spanning():
    ...
    event = {
        ...
        'start_datetime': datetime.datetime(2025, 5, 14, 10, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 16, 11, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': False
    }
    events = [event]
    filtered = calendar_routes._filter_events_for_day(events, target_date)
...
def test_filter_events_for_day_all_day_event():
    ...
    event = {
        ...
        'start_datetime': datetime.datetime(2025, 5, 15, 0, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 16, 0, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': True
    }
    events = [event]
    filtered = calendar_routes._filter_events_for_day(events, target_date)
...
def test_filter_events_for_day_event_outside_target():
    ...
    event = {
        ...
        'start_datetime': datetime.datetime(2025, 5, 16, 10, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 16, 11, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': False
    }
    events = [event]
...
def test_filter_events_for_day_sorting():
    ...
    target_date = datetime.date(2025, 5, 15)
    event1 = { # Later event
        'id': '1', 'summary': 'Later Event',
        'start_datetime': datetime.datetime(2025, 5, 15, 14, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 15, 15, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': False
    }
    event2 = { # All day event
        'id': '2', 'summary': 'All Day Event',
        'start_datetime': datetime.datetime(2025, 5, 15, 0, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 16, 0, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': True
    }
    event3 = { # Earlier event
        'id': '3', 'summary': 'Earlier Event',
        'start_datetime': datetime.datetime(2025, 5, 15, 9, 0, 0, tzinfo=datetime.timezone.utc),
        'end_datetime': datetime.datetime(2025, 5, 15, 10, 0, 0, tzinfo=datetime.timezone.utc),
        'all_day': False
    }
...
def test_view_route_default(
    mock_chores_list, mock_tasks, mock_lock, mock_thread, mock_get_weather, mock_db, client # Renamed mock_chores for clarity
):
        ...
        'daily': [
            {
                ...
                'sunrise': datetime.datetime(2025, 5, 2, 6, 0, tzinfo=datetime.timezone.utc),
                'sunset': datetime.datetime(2025, 5, 2, 20, 0, tzinfo=datetime.timezone.utc),
    ...
    mock_chores_data = [{'title': 'Household', 'notes': 'Take out trash', 'status': 'pending'}]
    ...
    with patch('src.calendar_app.routes.datetime') as mock_dt:
        now_fixed = datetime.datetime(2025, 5, 2, 12, 0, 0, tzinfo=datetime.timezone.utc)
...
def test_view_route_specific_month(
    mock_chores, mock_tasks, mock_lock, mock_thread, mock_get_weather, mock_db, client # Updated mock name
):
    ...
    mock_get_weather.return_value = {
        ...
        'daily': [
            {
                'date': datetime.date(2025, 5, 2), # Today's date for consistency in template
                'sunrise': datetime.datetime(2025, 5, 2, 6, 0, tzinfo=datetime.timezone.utc),
                'sunset': datetime.datetime(2025, 5, 2, 20, 0, tzinfo=datetime.timezone.utc),
            ...
            },
             {
                ...
                'sunrise': datetime.datetime(2025, 5, 3, 6, 1, tzinfo=datetime.timezone.utc),
                'sunset': datetime.datetime(2025, 5, 3, 20, 1, tzinfo=datetime.timezone.utc),
...
@patch('src.calendar_app.routes.google_fetch_lock')
@patch('src.calendar_app.routes.background_tasks', new_callable=dict)
def test_check_updates_no_task(mock_tasks, mock_lock, mock_sync_photos, client): # Updated mock name
...
def test_check_updates_task_running(mock_tasks, mock_lock, mock_sync_photos, client): # Updated mock name
...
@patch('src.calendar_app.routes.google_fetch_lock')
@patch('src.calendar_app.routes.background_tasks')
def test_check_updates_task_complete_with_updates(mock_tasks, mock_lock, mock_sync_photos, client): # Updated mock name
...
@patch('src.calendar_app.routes.google_fetch_lock')
@patch('src.calendar_app.routes.background_tasks')
def test_check_updates_task_complete_no_updates(mock_tasks, mock_lock, mock_sync_photos, client): # Updated mock name
